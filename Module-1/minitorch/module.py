...
class Module:
    ...
    def train(self):
        ...
        self.mode = "train"
        for _, c in enumerate(self.modules()):
            c.mode = "train"
    ...
    def named_parameters(self):
        ...
        for _, c in enumerate(self._modules):
            for _, i in enumerate(self._modules[c]._parameters):
                d.update({str(c) + "." + i: self._modules[c]._parameters[i]})
        return d
